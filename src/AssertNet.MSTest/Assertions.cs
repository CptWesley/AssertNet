...
namespace AssertNet.MSTest
{
    ...
    public static class Assertions
    {
        ...
        public static VoidAssertion AssertThat(Action action) => new VoidAssertion(new MSTestFailureHandler(), action);
        ...
        public static ExceptionAssertion AssertThat(Exception exception) => new ExceptionAssertion(new MSTestFailureHandler(), exception);
        ...
        public static BooleanAssertion AssertThat(bool value) => new BooleanAssertion(new MSTestFailureHandler(), value);
        ...
        public static DoubleAssertion AssertThat(double value) => new DoubleAssertion(new MSTestFailureHandler(), value);
        ...
        public static StringAssertion AssertThat(string value) => new StringAssertion(new MSTestFailureHandler(), value);
        ...
        public static EnumerableAssertion<T> AssertThat<T>(IEnumerable<T> enumerable) => new EnumerableAssertion<T>(new MSTestFailureHandler(), enumerable);
        ...
        public static SingleAssertion AssertThat(object value) => new SingleAssertion(new MSTestFailureHandler(), value);
    }
}
