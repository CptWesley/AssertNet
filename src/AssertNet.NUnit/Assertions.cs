...
namespace AssertNet.NUnit
{
    ...
    public static class Assertions
    {
        ...
        public static VoidAssertion AssertThat(Action action) => new VoidAssertion(new NUnitFailureHandler(), action);
        ...
        public static ExceptionAssertion AssertThat(Exception exception) => new ExceptionAssertion(new NUnitFailureHandler(), exception);
        ...
        public static BooleanAssertion AssertThat(bool value) => new BooleanAssertion(new NUnitFailureHandler(), value);
        ...
        public static DoubleAssertion AssertThat(double value) => new DoubleAssertion(new NUnitFailureHandler(), value);
        ...
        public static StringAssertion AssertThat(string value) => new StringAssertion(new NUnitFailureHandler(), value);
        ...
        /// <returns>Assertion about an enumerable.</returns>
        public static EnumerableAssertion<T> AssertThat<T>(IEnumerable<T> enumerable) => new EnumerableAssertion<T>(new NUnitFailureHandler(), enumerable);
        ...
        public static SingleAssertion AssertThat(object value) => new SingleAssertion(new NUnitFailureHandler(), value);
    }
}
