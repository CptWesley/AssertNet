namespace AssertNet.AssertionTypes.Void;
...
public static class ActionAssertions
{
    ...
    public static IAssertion<Exception> ThrowsException(this IAssertion<Action> assertion, string? message = null)
    {
        ...
        {
            return new Sut<Exception>(assertion.FailureHandler, e);
        }
        ...
        return new Sut<Exception>(assertion.FailureHandler, null!);
    }
        ...
        where T : Exception
    {
        ...
        {
            return new Sut<T>(assertion.FailureHandler, e);
        }
        catch (Exception e)
        {
            assertion.Fail(new LegacyFailureBuilder("ThrowsException()")
                ...
                .Append("But threw", e)
                .Finish());
            return new Sut<T>(assertion.FailureHandler, null!);
        }
