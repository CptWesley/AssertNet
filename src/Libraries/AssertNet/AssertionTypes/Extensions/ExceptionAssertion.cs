...
public static class ExceptionAssertions
{
    ...
    public static IAssertion<Exception> WithInnerException(this IAssertion<Exception> assertion, string? message = null)
    {
        ...
        return new Sut<Exception>(assertion.FailureHandler, assertion.Subject.InnerException, null);
    }
        ...
        where TInnerException : Exception
    {
        ...
        return new Sut<TInnerException>(assertion.FailureHandler, inner, null);
    }
}
