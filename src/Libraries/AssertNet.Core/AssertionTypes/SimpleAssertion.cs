...
public sealed class SimpleAssertion<TSubject> : Assertion<SimpleAssertion<TSubject>, TSubject>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SimpleAssertion{TSubject}"/> class.
    /// </summary>
    /// <param name="failureHandler">The failure handler of the assertion.</param>
    /// <param name="subject">The object which is under test.</param>
    public SimpleAssertion(IFailureHandler failureHandler, TSubject subject)
