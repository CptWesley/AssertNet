...
namespace AssertNet.Xunit
{
    ...
    public static class Assertions
    {
        ...
        {
            return new VoidAssertion(new XunitFailureHandler(), action);
        }
        ...
        {
            return new ExceptionAssertion(new XunitFailureHandler(), exception);
        }
        ...
        {
            return new BooleanAssertion(new XunitFailureHandler(), value);
        }
        ...
        {
            return new DoubleAssertion(new XunitFailureHandler(), value);
        }
        ...
        {
            return new StringAssertion(new XunitFailureHandler(), value);
        }
        ...
        {
            return new EnumerableAssertion<T>(new XunitFailureHandler(), enumerable);
        }
        ...
        {
            return new SingleAssertion(new XunitFailureHandler(), value);
        }
    }
}
