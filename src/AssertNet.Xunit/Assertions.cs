...
namespace AssertNet.Xunit
{
    ...
    public static class Assertions
    {
        ...
        public static VoidAssertion AssertThat(Action action) => new VoidAssertion(new XunitFailureHandler(), action);
        ...
        public static ExceptionAssertion AssertThat(Exception exception) => new ExceptionAssertion(new XunitFailureHandler(), exception);
        ...
        public static BooleanAssertion AssertThat(bool value) => new BooleanAssertion(new XunitFailureHandler(), value);
        ...
        public static DoubleAssertion AssertThat(double value) => new DoubleAssertion(new XunitFailureHandler(), value);
        ...
        public static StringAssertion AssertThat(string value) => new StringAssertion(new XunitFailureHandler(), value);
        ...
        public static SingleAssertion AssertThat(object value) => new SingleAssertion(new XunitFailureHandler(), value);
    }
}
